...
// New reusable component to handle dynamic aspect ratio videos
    ...
    return (
        <div
            style={{
                position: "relative",
                width: "100%",
                paddingTop: `${100 / aspectRatio}%`, // maintain dynamic aspect ratio container
                backgroundColor: "#000",
                borderRadius: "8px",
                overflow: "hidden",
            }}
        >
            <video
                ...
                style={{
                    ...
                    width: "100%",
                    height: "100%",
                    objectFit: "contain", // better for variable ratios (no cropping)
                }}
            >
                                                    ...
                                                    <div className="ttm-bgcolor-grey spacing-12">
                                                        ...
                                                        <div className="wpb_wrapper">
                                                            ...
                                                            {item?.contact_number && (
                                                                <a
                                                                    href={`https://wa.me/${
                                                                        item.contact_number.startsWith("0")
                                                                            ? "92" + item.contact_number.slice(1)
                                                                            : item.contact_number
                                                                    }`}
                                                                    target="_blank"
